...
export const IcoCodewars = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    <path d="M21.483 0L12 9.484 2.517 0 0 2.517 9.484 12 0 21.483 2.517 24 12 14.516 21.483 24 24 21.483 14.516 12 24 2.517z" />
  </svg>
)
...
export const IcoBriefcase = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4">
    ...
    <path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2M12 12v.01" strokeLinecap="round" />
  </svg>
)
...
export const IcoPencil = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4">
    ...
    <path d="M16.5 3.5a2.121 2.121 0 113 3L7 19l-4 1 1-4 12.5-12.5z" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
